...
class Header extends Component {
            ...
            <header>
                <section>
                    <form onSubmit={e => this.handleClick(e)}>
                        ...
                        <input onKeyUp={this.handleKeyUp.bind(this)} ref="inputnew" type="text"
                               placeholder="新建事项(20字以内)" defaultValue={this.props.text} id="new-todo" className="note"/>
                        <div className="btns">
    ...
    handleClick(e) {
        e.preventDefault();
        const inputNode = this.refs.inputnew;
        const text = inputNode.value.trim();
        if (text.length > 20) {
